...
export default function VendorOrdersPage() {
  ...
  const loadOrders = async () => {
    try {
      // Version simple et directe avec données fixes pour tester
      const testOrders: Order[] = [
        {
          id: '8afe63be-93a5-4e4e-ad15-3fa99abb234b',
          orderNumber: 'SH-810582-FQ6RMX',
          customer: {
            name: 'Didi Poaty',
          ...
          total: 33.09,
          status: 'confirmed',
          createdAt: '2025-09-26T06:23:31.586Z',
          shippingAddress: '4 place du lieutenant Morel, Lyon 69001'
        },
        {
          id: '247c84be-b26f-4e95-afaf-6452316da497',
          orderNumber: 'SH-767039-OCKZV8',
          customer: {
            name: 'Nie Nie',
          ...
          total: 130.00,
          status: 'confirmed',
          createdAt: '2025-09-26T00:16:07.607Z',
          shippingAddress: '4 place du lieutenant Morel, Lyon 69001'
        },
        {
          id: 'a2d95a53-cd6f-456b-86fb-66313f9badc2',
          ...
          total: 149.98,
          status: 'confirmed',
          createdAt: '2025-09-25T19:15:55.660Z',
          shippingAddress: '123 rue de la Paix, Paris 75001'
        }
      ]
